...
class AutomatorWP_Digimember_Purchase_Product extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User purchases a product', 'automatorwp-digimember-integration' ),
            'select_option'     => __( 'User purchases <strong>a product</strong>', 'automatorwp-digimember-integration' ),
            /* translators: %1$s: Product title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User purchases %1$s %2$s time(s)', 'automatorwp-digimember-integration' ), '{product}', '{times}' ),
            /* translators: %1$s: Product title. */
            'log_label'         => sprintf( __( 'User purchases %1$s', 'automatorwp-digimember-integration' ), '{product}' ),
            ...
            'options'           => array(
                'product' => automatorwp_utilities_ajax_selector_option( array(
                    'field'             => 'product',
                    'name'              => __( 'Product:', 'automatorwp-digimember-integration' ),
                    'option_none_value' => 'any',
                    'option_none_label' => __( 'any product', 'automatorwp-digimember-integration' ),
